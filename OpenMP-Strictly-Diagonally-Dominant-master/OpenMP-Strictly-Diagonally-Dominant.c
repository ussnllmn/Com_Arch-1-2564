...
#include <stdlib.h>
#include <omp.h>
//if you can't run type "-std=c99 -fopenmp" in complier option
...
//	scanf("%d", &t);
	...
	printf("Number of threads I'd like to use is %d\n",t);
	
//	scanf("%d", &N);
    N=3;
	printf("Main dimension for your \"A\" input matrix is %d",N); 
	...
	//New value fix if you change main dimension value N on above please change value in this place too
    int value[3][3] = {
    {-4, 2, 1},
    { 1, 6, 2},
    { 1, -2,5}
